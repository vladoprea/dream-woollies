"""
Code written following Code Institute video lessons on Stripe payments
"""
...
class StripeWH_Handler:
    ...
    # Handles confirmation emails sent to users after their order is complete
        ...
        while attempt <= 5:
            try: 
                order = Order.objects.get(
                    ...
                    address_addition__iexact=billing_details.address.line2,
        ...
        if order_exists:
            ...
            try:
                order = Order.objects.create(
                        ...
                        address_addition=billing_details.address.line2,
