    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_street_address', models.CharField(blank=True, max_length=120, null=True)),
                ('default_address_addition', models.CharField(blank=True, max_length=80, null=True)),
